...
const {signin_restaurent,signup_restaurent,add_post, remove_posts,update_posts,delete_profile,update_profile,get_posts,get_restaurents,deleteOnePost,addComments}=require('../controllers/restaurents/index')
...
restaurents.post('/addComments/:id',addComments)
// restaurents.get('getComments')
// restaurents.delete('delComment') 
